...
namespace KodlamaioDevs.Application.Features.ProgrammingLanguages.Queries.GetByIdProgrammingLanguage
{
    public class GetByIdProgrammingLanguageQuery : IRequest<ProgrammingLanguageGetByIdDto>
    {
        ...
        public class GetByIdProgrammingLanguageQueryHandler : IRequestHandler<GetByIdProgrammingLanguageQuery, ProgrammingLanguageGetByIdDto>
        {
            ...
            {
                ProgrammingLanguage? result= await _programmingLanguageRepository.GetAsync(a => a.Id == request.Id);
                _programmingLanguageBusinessRules.ProgrammingLanguageShouldExistWhenRequest(result);

                ProgrammingLanguageGetByIdDto mappedResult = _mapper.Map<ProgrammingLanguageGetByIdDto>(result);
                return mappedResult;
